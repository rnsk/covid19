<template>
  <div class="About">
    ...
    <TextCard>
      当サイトは新型コロナウイルス感染症（COVID-19）に関する最新情報を提供するために、有志が開設したものです。<br />
      <br />
      岐阜県による公式情報と客観的な数値をわかりやすく伝えることで、岐阜県にお住まいの方や、岐阜県内に拠点を持つ企業の方、岐阜県を訪れる方が、現状を把握して適切な対策を取れるようにすることを目的としています。岐阜県の公式情報を利用していますが、このサイト自体は非公式となります。
    </TextCard>

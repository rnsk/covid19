...
@include lessThan(1170) {
  @include override(1170, 2, 12, 107, 24);
}
// Vuetify Breakpoints: Small (960)
@include lessThan(959) {
  @include override(960, 4, 13, 180, 40);
}
@include lessThan(767) {
  @include override(960, 3, 13, 180, 40);
}
// Vuetify Breakpoints: Extra Small (600)
@include lessThan(600) {
  @include override(600, 3, 13, 150, 35);
}
@include lessThan(420) {
  @include override(600, 2, 11, 150, 35);
}
</style>
